...
#----------------------
#keep only terrestrial
trait <- trait[which(trait$eco=="T"),]
...
write.csv(ci,"G:/My Drive/BIOSHIFTS Working Group/Preliminary_analyses/traits_coverage/Coefficents_ModelsBodySize_fixed_allgps_full_T.csv",row.names=F)
write.csv(dd,"G:/My Drive/BIOSHIFTS Working Group/Preliminary_analyses/traits_coverage/Coefficents_ModelsBodySize_random_allgps_full_T.csv",row.names=F)
write.csv(R2,"G:/My Drive/BIOSHIFTS Working Group/Preliminary_analyses/traits_coverage/R2_allgps_full_T.csv",row.names=F)
...
jpeg("G:/My Drive/BIOSHIFTS Working Group/Preliminary_analyses/traits_coverage/ModelVelocity_allgps_full_T.jpeg",width = 16*900/cm(1),height = 10*900/cm(1),res=900,pointsize=6)
...
jpeg("G:/My Drive/BIOSHIFTS Working Group/Preliminary_analyses/traits_coverage/ModelBodySize_allgps_full_T.jpeg",width = 16*900/cm(1),height = 10*900/cm(1),res=900,pointsize=6)
...
jpeg("G:/My Drive/BIOSHIFTS Working Group/Preliminary_analyses/traits_coverage/ModelInteractionBodySizeVelocity_allgps_full_T.jpeg",width = 16*900/cm(1),height = 10*900/cm(1),res=900,pointsize=6)
...
jpeg("G:/My Drive/BIOSHIFTS Working Group/Preliminary_analyses/traits_coverage/ModelVelocity_allgps_full_ele_T.jpeg",width = 16*900/cm(1),height = 10*900/cm(1),res=900,pointsize=6)
...
jpeg("G:/My Drive/BIOSHIFTS Working Group/Preliminary_analyses/traits_coverage/ModelBodySize_allgps_full_ele_T.jpeg",width = 16*900/cm(1),height = 10*900/cm(1),res=900,pointsize=6)
...
jpeg("G:/My Drive/BIOSHIFTS Working Group/Preliminary_analyses/traits_coverage/ModelInteractionBodySizeVelocity_allgps_full_ele_T.jpeg",width = 16*900/cm(1),height = 10*900/cm(1),res=900,pointsize=6)
