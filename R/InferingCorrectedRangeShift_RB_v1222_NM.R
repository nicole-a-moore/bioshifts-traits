...
#### DATASET preparation ####
#############################
rSdata = read.table("data-raw/bioshifts-download/Lenoir_et_al/Analysis/Table_S1.csv",sep=";",h=T,dec=".",stringsAsFactors = FALSE) 
...
#transforming continuous method variables in qualitative variables => two benefits: 
## (1) all variables are qualitative 
## (2) better than quantitative in case the effect is not linear
